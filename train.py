...
from data.new_load_data import get_dataset, get_combined_dataset
try:
...
parser.add_argument('--imagenet_path', metavar='DIR', default="", 
...
parser.add_argument('--comb_dataset', type=str, nargs='*', default=None, help='A list of dataset')
...
group.add_argument('--decay-milestones', default=[50, 100, 150], type=int, nargs='+', metavar="MILESTONES",
                   help='list of decay epoch indices for multistep lr. must be increasing')
...
def main():
    ...
    dataset_test = get_dataset(args.imagenet_path, split="val",subset=args.dataset, filelist="new_file_list.txt")
    ...
    loader_train = create_loader(
        ...
        # mean=(0.4754, 0.4562, 0.4154),
        # std=(0.2323, 0.2271, 0.2275),
